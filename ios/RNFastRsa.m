...
//     @try {
//         NSError *error;
//         NSString * output = [[self instance] decryptOAEP:message label:label hashName:hashName publicKey:publicKey error:&error];
//         if(error!=nil){
...
//     @try {
//         NSError *error;
//         NSString * output = [[self instance] decryptPKCS1v15:message publicKey:publicKey error:&error];
//         if(error!=nil){
//             reject([NSString stringWithFormat:@"%ld",(long)[error code]], [error description],error);
//         }else{
//             resolve(output);
...
//     @try {
//         NSError *error;
//         NSString * output = [[self instance] signPKCS1v15:message hashName:hashName publicKey:publicKey error:&error];
...
//     @try {
//         NSError *error;
//         NSString * output = [[self instance] signPSS:message hashName:hashName publicKey:publicKey error:&error];
...
//         NSError *error;
//         BOOL ret0_;
//         BOOL output = [[self instance] verifyPSS:signature message:message hashName:hashName publicKey:publicKey ret0_:&ret0_ error:&error];
